...
void oldloop() {  
  setAllDigipotChannels(digipotValue);  
  /*
  Serial.print("Digipots: ");
...
//  test();
  ...
  secondCounter = ((float)integrationTime/1000.0f);
/*
...
*/
  ...
  // Index digipot value    
  digipotValue = digipotValue + digipotDelta;
  
  // Clear counts
  clearCounts();
    
  if ((digipotValue < digipotMinVal) || (digipotValue > digipotMaxVal)) {
  ...
  Serial.print("c   ");
  float cpm = (pulseCounter / secondCounter) * 60.0f;  
  Serial.print(cpm);
  Serial.println("cpm");
  */
